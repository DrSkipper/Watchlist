...
2) Open the corresponding XML file in Assets/Data (Notepad++ is fine). Also open the .csv in something like Notepad++ which lets you view the raw text.
...
4) Open the corresponding XML file in Assets/Data. Also open the corresponding .csv file in something like Notepad++.
